...
from app.authz.legacy_guards.abort_with_flash import va_permission_abortwithflash
from flask import request, url_for, flash, make_response, abort


def va_permission_ensureallocation(sid, role):
