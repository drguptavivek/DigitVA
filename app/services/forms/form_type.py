    ...
    def duplicate_form_type(
        ...
        for category_display in db.session.scalars(
            ...
            db.session.add(MasCategoryDisplayConfig(
                ...
                show_to_site_pi_datamanager=category_display.show_to_site_pi_datamanager,
        ...
        category_display_configs = [
            {
                ...
                "show_to_site_pi_datamanager": c.show_to_site_pi_datamanager,
    ...
    def import_form_type(
        ...
        for cat in data.get("category_display_configs") or []:
            db.session.add(MasCategoryDisplayConfig(
                ...
                show_to_site_pi_datamanager=cat.get("show_to_site_pi_datamanager", True),
