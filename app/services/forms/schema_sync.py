"""Synchronize ODK form schema metadata into DigitVA form configuration.
...
This module belongs to the forms service boundary. The ODK package owns
transport/client concerns; this service translates ODK schema data into
``mas_*`` field and choice configuration used by rendering and admin screens.
"""
import uuid
import io
import time
