"""Resolve runtime form type codes for legacy `va_forms` records.

Prefer `VaForms.form_type_id` when present, fall back to the legacy text
`form_type`, and finally to the default mapping service form type.
"""
