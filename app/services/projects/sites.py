"""Legacy research-site seed helpers.

Current site management is handled by the admin route/services. This module
only keeps the bootstrap add helper used by historical seed flows.
"""

from app import db
from app.models import VaSites
from app.validators.projects import validate_project_id, validate_site_id
