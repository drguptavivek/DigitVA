"""Legacy VA form route helper functions.

These helpers support category rendering and action responses used by the
`vaform` route package while that surface is migrated toward services.
"""
...
from app.services.forms.legacy_mappings.field_coder import va_mapping_fieldcoder
