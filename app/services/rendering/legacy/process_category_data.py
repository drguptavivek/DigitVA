"""Render one VA category from payload values and field mapping metadata.

The helper filters empty/DK/ref values, resolves choice labels, normalizes
dates/numbers, and builds attachment URLs for the server-rendered VA form UI.
"""
...
from app.services.rendering.legacy.format_datetime_indian import va_render_formatdatetimeindian
