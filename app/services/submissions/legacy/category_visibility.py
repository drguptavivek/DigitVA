"""Compute category visibility for a submission payload.

This bridges the legacy `va_submissions.va_category_list` field to the
DB-backed category and field mapping services.
"""
