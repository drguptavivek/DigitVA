...
| `Id10387`, `Id10388`, `Id10389`, `Id10369`, `Id10382`, `Id10383`, `Id10384`, `Id10385`, `Id10403`, `Id10404`, `Id10405` | Neonatal Period Details / delivery | [Neonatal Delivery](neonatal-delivery.md) | explicit visible retained subset plus downstream features fed by hidden or other-subcategory fields |
...
| `Id10391`, `Id10393`, `Id10395`, `Id10396`, `Id10397`, `Id10398`, `Id10399`, `Id10400`, `Id10401`, `Id10402` | Neonatal Period Details / baby_mother | [Neonatal Baby Mother](neonatal-baby-mother.md) | explicit retained one-hot complication subset with cross-subcategory merge |
...
| `Id10351`, `Id10408` | Health History Details / neonate | [Health History Neonate](health-history-neonate.md) | explicit helper-driven onset-age path plus one ignored growth field |
...
| `Id10123`, `Id10121`, `Id10122`, `Id10120` | General Symptoms / duration_of_illness | [Duration Of Illness](duration-of-illness.md) | child/neonate duration path explicit; adult visible WHO 2022 duration fields not explicitly wired |
...
| `Id10247`, `Id10248_b`, `Id10248` | General Symptoms / puffiness | [Swelling](swelling.md) | explicit retained adult puffiness family |
| `Id10249`, `Id10250_b`, `Id10250`, `Id10251` | General Symptoms / swelling | [Swelling](swelling.md) | visible leg/feet-swelling block not explicitly wired in this fork |
...
| `Id10174`, `Id10175`, `Id10176`, `Id10179`, `Id10179_1` | Respiratory / Cardiac Symptoms / chest_pain | [Chest Pain](chest-pain.md) | adult presence and duration explicit; activity/location remain downstream-only without visible WHO 2022 mappings |
...
| `Id10207` | Neurological Symptoms / headache | [Headache](headache.md) | downstream adult family exists, but no visible WHO 2022 adapter path is surfaced |
| `Id10486` | Neurological Symptoms / smell_taste | [Smell Or Taste](smell-taste.md) | ignored across adult, child, and neonate |
| `Id10212`, `Id10213_a`, `Id10213` | Neurological Symptoms / mental_confusion | [Mental Confusion](mental-confusion.md) | downstream adult family exists, but no visible WHO 2022 adapter path is surfaced |
...
| `Id10208`, `Id10209_b`, `Id10209` | Neurological Symptoms / stiff_painful_neck | [Stiff Neck](stiff-neck.md) | adult/child presence explicit; adult duration not visibly wired from WHO 2022 fields |
...
| `Id10281`, `Id10282`, `Id10283` | Neonatal Feeding Symptoms / unresponsive | [Neonatal Unresponsive](neonatal-unresponsive.md) | `Id10281` explicit; `Id10282` and `Id10283` not mapped as first-class inputs |
...
| `Id10337`, `Id10332`, `Id10342`, `Id10343`, `Id10344`, `Id10331`, `Id10330`, `Id10328`, `Id10322_b`, `Id10329_a` | Maternal Symptoms / delivery | [Maternal Delivery](maternal-delivery.md) | visible labor-duration/bleeding subset explicit; remaining maternal-delivery symptoms depend on hidden older fields |
