...
| D2 | Does "skip Step 1" also apply to the reviewer track? | Yes, one project setting `skip_initial_cod_assessment` governs both coder Step 1 and reviewer initial COD. |
