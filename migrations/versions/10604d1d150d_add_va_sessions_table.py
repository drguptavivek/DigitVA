"""add va_sessions table

Revision ID: 10604d1d150d
Revises: 63ea1af09ef0
Create Date: 2026-03-10 10:24:58.091878
...
revision = '10604d1d150d'
down_revision = '63ea1af09ef0'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # Use IF EXISTS — these tables only exist when upgrading from an older DB
    # that had django-celery-beat tables; a fresh DB won't have them.
    for tbl in [
...
def downgrade():
    ...
    sa.PrimaryKeyConstraint('id', name='celery_interval_schedule_pkey')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='celery_solar_schedule_pkey')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='celery_crontab_schedule_pkey')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='celery_periodic_task_pkey'),
    sa.UniqueConstraint('name', name='celery_periodic_task_name_key')
    )
    ...
    sa.PrimaryKeyConstraint('id', name='celery_periodic_task_changed_pkey')
    )
