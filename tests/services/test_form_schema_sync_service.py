"""
Tests for form schema sync service.
...
Run (inside Docker):
  docker compose exec minerva_app_service uv run pytest tests/services/test_form_schema_sync_service.py -v
"""
import uuid
...
class TestFormSchemaSyncService(BaseTestCase):
    """
    ...
    def test_02_sync_returns_stats_dict(self):
        ...
        with patch("app.services.forms.schema_sync.va_odk_clientsetup") as mock_setup:
            mock_client = Mock()
